...
public class GridP : MonoBehaviour
{
    ...
    void CreateGrid()
    {
        ...
        for (int x = 0; x < iGridSizeX; x++)        //Loop through the array of nodes on the X
        {
            for (int y = 0; y < iGridSizeY; y++)    //Loop through the array of nodes on the Y
            {
    ...
    /// </summary>
    /// <param name="a_NeighborNode"></param>
    /// <returns></returns>
